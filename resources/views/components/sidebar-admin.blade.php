    ...
    <div class="scrollbar-inner">
        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link font-weight-bold mb-3" href="/admin">
                    ...
                    <li class="nav-item mt--4">
                        <a class="nav-link" disabled>
                            <h6 class="nav-link-text text-gray">ADMIN</h6>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link mb-3" href="/admin/masyarakat">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="" data-toggle="modal" data-target="#admin-logout">
