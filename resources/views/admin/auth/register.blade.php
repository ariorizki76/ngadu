              ...
              <div class="form-block">
                ...
                <div class="container-fluid">
                  <div class="form-group mb-4">
                    <label for="nama_petugas"><i class="fas fa-user" style="color: #7142d6"></i>&nbsp;&nbsp;&nbsp;Nama</label>
                  ...
                  <div class="form-group mb-4">
                    <label for="username"><i class="fas fa-user-tag" style="color: #7142d6"></i>&nbsp;&nbsp;&nbsp;Username</label>
                  ...
                  <div class="form-group mb-4">
                    <label for="telp"><i class="fas fa-phone" style="color: #7142d6"></i>&nbsp;&nbsp;&nbsp;No. Telepon</label>
                  ...
                  <div class="col">
                  <div class="form-group mb-5">
                    <label for="password_confirm"><i class="fas fa-lock" style="color: #7142d6"></i>&nbsp;&nbsp;&nbsp;Confirm Password</label>
