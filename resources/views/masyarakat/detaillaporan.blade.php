    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h3 class="m-0 font-weight-bold text-primary"><i class="fas fa-info-circle"></i>&nbsp;&nbsp;Info
                            Status</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-8">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h3 class="m-0 font-weight-bold text-primary"><i class="fas fa-reply"></i>&nbsp;&nbsp;Tanggapan
                        </h3>
                    </div>
                    <div class="card-body">
