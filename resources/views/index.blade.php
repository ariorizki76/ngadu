    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Layanan penyampaian informasi berupa keluhan oleh masyarakat</h1>
          <h2>Sampaikan keluhan anda sekarang juga!</h2>

          @if(Auth()->guard('masyarakat')->check())
          <div><a href="/pengaduan" class="btn-get-started scrollto">Buat Pengaduan!</a></div>
          @else
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            <h3>blom tau isinya apaan</h3>
            <p class="font-italic">
              sama ini juga
            </p>
            <ul>
              <li><i class="icofont-check-circled"></i> ini juga</li>
              <li><i class="icofont-check-circled"></i> ini juga</li>
              <li><i class="icofont-check-circled"></i> ini juga</li>
            </ul>
