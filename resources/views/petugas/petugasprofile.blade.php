                ...
                <div class="card-body pt-0">
                    ...
                    <div class="text-center mt--5">
                        ...
                        <div class="h5 font-weight-300">
                            <i class="ni location_pin mr-2"></i>{{$petugas->email}}
<br>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('petugas.update')}}" method="POST">
                        ...
                        <div class="container">
                            ...
                            <div class="form-group mb-4 row">
                            <label class="col-sm-1 col-form-label" for="email"><i class="fas fa-envelope text-primary"></i></label>
                            <div class="col-lg-11">
                            ...
                            <div class="form-group mb-4 row">
                            <label class="col-sm-1 col-form-label" for="username"><i class="fas fa-user-tag text-primary"></i></label>
                            <div class="col-lg-11">
                            ...
                            <div class="form-group mb-4 row">
                            <label class="col-sm-1 col-form-label" for="telp"><i class="fas fa-phone text-primary"></i></label>
                            <div class="col-lg-11">
                                <input type="tel" name="telp" id="telp" class="form-control" value="{{$petugas->telp}}"
